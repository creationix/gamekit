...
You must call SDL_Init(SDL_INIT_TIMER) first
SDL_UpperBlit: passed a NULL surface
OpenGL active, use SDL_GL_SwapBuffers()
...
SDL_FB_BROKEN_MODES
SDL_NOMOUSE
"%s" is not a valid value for SDL_VIDEO_FBCON_ROTATION
SDL_JOYSTICK_DEVICE
SDL_LINUX_JOYSTICK
SDL_CDROM
]]
